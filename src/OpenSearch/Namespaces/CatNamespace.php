...
class CatNamespace extends AbstractNamespace
{
     ...
     *
     * $params['name']             = (any) A comma-separated list of aliases to retrieve. Supports wildcards (`*`).  To retrieve all aliases, omit this parameter or use `*` or `_all`.
     ...
     *
     * $params['node_id']                 = (any) Comma-separated list of node identifiers or names used to limit the returned information.
     * $params['format']                  = (string) A short version of the Accept header, e.g. json, yaml.
     ...
     *
     * $params['fields']      = (any) Comma-separated list of fields used to limit returned information. To retrieve all fields, omit this parameter.
     * $params['format']      = (string) A short version of the Accept header, e.g. json, yaml.
     * $params['bytes']       = (enum) The unit used to display byte values. (Options = b,k,kb,m,mb,g,gb,t,tb,p,pb)
     * $params['h']           = (array) Comma-separated list of column names to display.
     * $params['help']        = (boolean) Return help information. (Default = false)
     ...
     *
     * $params['index']       = (any) A comma-separated list of data streams, indices, and aliases used to limit the request. Supports wildcards (`*`). To target all data streams and indices, omit this parameter or use `*` or `_all`.
     * $params['format']      = (string) A short version of the Accept header, e.g. json, yaml.
     ...
     *
     * $params['index']              = (string) Comma-separated list or wildcard expression of index names to limit the returned information.
     * $params['format']             = (string) A short version of the Accept header, e.g. json, yaml.
     * $params['h']                  = (array) Comma-separated list of column names to display.
     * $params['help']               = (boolean) Return help information. (Default = false)
     * $params['s']                  = (array) Comma-separated list of column names or column aliases to sort by.
     ...
     *
     * $params['repository']              = (any) A comma-separated list of snapshot repositories used to limit the request. Accepts wildcard expressions. `_all` returns all repositories. If any repository fails during the request, Opensearch returns an error.
     * $params['format']                  = (string) A short version of the Accept header, e.g. json, yaml.
     ...
     *
     * $params['thread_pool_patterns']    = (any) A comma-separated list of thread pool names used to limit the request. Accepts wildcard expressions.
     * $params['format']                  = (string) A short version of the Accept header, e.g. json, yaml.
